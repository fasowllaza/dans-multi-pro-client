        ...
        return (
            ...
            <div className='grid grid-cols-1 md:grid-cols-6'>
                <div className='col-span-2 py-2 px-2'>
                    <p1 className="font-semibold">Job Description</p1>
                    <input
                        id="description"
                ...
                <div className='col-span-2 py-2 px-2'>
                    <p1 className="font-semibold">Location</p1>
                    <input
                        id="description"
                        className="w-full px-4 py-2 mt-2 border rounded-md focus:ring focus:ring-blue-200"
                        value={location}
    ...
    return (
        <Container>
            ...
            <div className='px-2 mb-8'>
                <button onClick={() => handleAddPage()} className='w-full bg-blue-500 text-white h-12'>More Jobs</button>
            </div>
        </Container>
    )
}
