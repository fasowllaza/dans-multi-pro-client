        ...
        <Container>
            <div className="py-2 px-2">
                <div onClick={() => history.goBack()}>
                    <p className="text-blue-800 font-bold" >Back</p>
                </div>
            </div>
            <div className="bg-white px-2 py-2 mb-4">
                <p className="text-slate-400">{detailData?.type} / {detailData?.location}</p>
            ...
            <div className="grid md:grid-cols-6">
                ...
                <div className="col-span-2 py-4 px-4">
                    <div className="border-8 py-4 px-4">
                        ...
                        <a className="text-blue-700" href={ detailData?.company_url } target="_blank">{detailData?.company_url}</a>
                    </div>
